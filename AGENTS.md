...
Hard rule 3 governs every teardown and scout discard.
Load `task-delivery` before cleanup, and treat any refusal from `bin/fm-teardown.sh` as a stop-and-investigate result.
