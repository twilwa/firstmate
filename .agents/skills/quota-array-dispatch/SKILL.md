...
`task-intake` owns the intake boundary, load trigger, and malformed-config refusal; this skill owns every-candidate accounting and strongest-reasoning and tie safety rules.
