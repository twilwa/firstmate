...
Codex and OpenCode are also verified and supported as primary harnesses; Codex uses a synchronous Stop-hook watcher park, and OpenCode uses a TUI plugin, so both carry more harness-specific supervision tradeoffs than the three co-primaries.
