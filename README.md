...
An OpenCode primary is unsupported on OpenCode 2.0 until the `fm-primary-*` plugins are ported to its default-definition loader; see [the OpenCode harness reference](.agents/skills/harness-adapters/references/harness/opencode.md).
