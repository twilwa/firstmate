...
It proves a brief rewritten right after the resolver's snapshot copy still sends its original sections and scout line, or its original whole text on the fallback, and that the receipt's `brief_sha256` hashes those same original bytes.
