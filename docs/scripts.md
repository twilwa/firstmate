...
| `fm-pr-merge.sh`         | Guard the reviewed-head GitHub handoff or a direct GitLab merge, record PR metadata, refuse a Gerrit change because firstmate never submits one, and refuse an outcome it cannot prove landed or queued |
